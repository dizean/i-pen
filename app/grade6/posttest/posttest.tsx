  ...
  const { username, setPostTestScore } = useUser();
    ...
    const generateQuestions = (count: number): Question[] => {
      ...
      for (let i = 0; i < count; i++) {
        let num1 = Math.floor(Math.random() * (65 - 25 + 1)) + 25; 
        let num2 = Math.floor(Math.random() * (65 - 25 + 1)) + 25; 
        const operations = ["+", "-", "*","/","+", "-", "*", "/"];
        // const operations = [ "/"];
        ...
        if (operation === "+") {
          ...
          num1 = Math.floor(Math.random() * (15 - 8 + 1)) + 8; 
          num2 = Math.floor(Math.random() * (15 - 8 + 1)) + 8; 
          correctAnswer = num1 * num2;
        }
        else {
          num2 = Math.floor(Math.random() * (15 - 8 + 1)) + 8; 
