  ...
  const { username, setPreTestScore } = useUser();
    ...
    const generateQuestions = (count: number): Question[] => {
      ...
      for (let i = 0; i < count; i++) {
        let num1 = Math.floor(Math.random() * (50 - 15 + 1)) + 15; 
        let num2 = Math.floor(Math.random() * (50 - 15 + 1)) + 15; 
        const operations = ["+", "-", "*","/","+", "-", "*", "/"];
        // const operations = [ "*"];
        ...
        if (operation === "+") {
          ...
          num1 = Math.floor(Math.random() * (12 - 6 + 1)) + 5; 
          num2 = Math.floor(Math.random() * (12 - 6 + 1)) + 5;
          correctAnswer = num1 * num2;
        }
        else {
