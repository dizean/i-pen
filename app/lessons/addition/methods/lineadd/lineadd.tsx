...
const LineAdd = forwardRef((props, ref) => {
  ...
  const content = [
    ...
    { id: 6, text: "Add 10 and 3", styling: [styles.text, styles.formula] },
    ...
    { id: 10, text: "Hence,", styling: styles.text },
    { id: 11, text: "10 + 3 = 13.", styling: [styles.text, styles.formula] },
  ];
  const imageIndexes = [7, 10];
    ...
    <AntDesign name="home" size={50} color="#fff" />
      ...
      <View style={styles.container}>
          ...
          {imageIndexes.includes(index) && (
              <Image
                source={require("../../../../../assets/images/lineadd.png")}
