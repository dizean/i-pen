...
const WRegroup = forwardRef((props, ref) => {
  ...
  const content = [
    ...
    { id: 6, text: "Add 3475 and 2865", styling: [styles.text, styles.formula] },
    ...
    { id: 9, text: "Step 1:", styling: [styles.text, styles.steps] },
    { id: 10, text: "Start with the digits in the ones (O) column.", styling: styles.text },
    { id: 11, text: "5 + 5 = 10", styling: [styles.text, styles.formula] },
    ...
    { id: 15, text: "1 (carry-over) + 7 + 6 = 14", styling: [styles.text, styles.formula] },
    ...
    { id: 17, text: "Step 3:", styling: [styles.text, styles.steps] },
    { id: 18, text: "Now, add the digits in the hundreds (H) place along with the carryover digit 1.", styling: styles.text },
    { id: 19, text: "1 (carry-over) + 4 + 8 = 13.", styling: [styles.text, styles.formula] },
    ...
    { id: 23, text: "1 (carry-over) + 3 + 2 = 6.", styling: [styles.text, styles.formula] },
    { id: 24, text: "Step 5", styling: [styles.text, styles.steps] },
    { id: 25, text: "Therefore,", styling: styles.text },
    { id: 26, text: "3475 + 2865 = 6340", styling: [styles.text, styles.formula] },
  ];
  const imageIndexes = [9, 13, 17, 21, 24];
      ...
      {content.map((line, index) => (
        <View style={styles.container}>
          ...
          {imageIndexes.includes(index) && (
            <Image
              source={require("../../../../../assets/images/wregroup.png")}
