...
const Parts = forwardRef((props, ref) => {
  ...
  const content = [
    { id: 1, text: "Parts of Subtraction", styling: styles.subtitle },
    { id: 2, text: "Minuend", styling: styles.sectiontititle },
    { id: 3, text: "The number from which the other number is subtracted.", styling: styles.text },
    { id: 4, text: "Subtrahend", styling: styles.sectiontititle },
    { id: 5, text: "The number which is to be subtracted from the minuend.", styling: styles.text },
    { id: 6, text: "Difference", styling: styles.sectiontititle },
    { id: 7, text: "The final result after subtracting the subtrahend from the minuend.", styling: styles.text },
  ];  
