...
const MakeEqual = forwardRef((props, ref) => {
  const [isSpeaking, setIsSpeaking] = useState(false);
  const [currentIndex, setCurrentIndex] = useState<number>(-1);
  const router = useRouter();
  const content = [
    { id: 1, text: "Ways to Solve Division", styling: styles.subtitle },
    { id: 2, text: "Make Equal Group", styling: styles.sectiontititle },
    { id: 3, text: "Example :", styling: [styles.text, styles.steps] },
    { id: 4, text: "8 ÷ 4", styling: [styles.text, styles.formula] },
    { id: 5, text: "Solution :", styling: [styles.text, styles.steps] },
    { id: 6, text: "Group the cats into 4.", styling: styles.text },
    { id: 7, text: "8 ÷ 4 = 2", styling: [styles.text, styles.formula] },
  ];
