...
const RepeatedSubtraction = forwardRef((props, ref) => {
  const [isSpeaking, setIsSpeaking] = useState(false);
  const [currentIndex, setCurrentIndex] = useState<number>(-1);
  const router = useRouter();
  const content = [
    { id: 1, text: "Ways to Solve Division", styling: styles.subtitle },
    { id: 2, text: "Repeated Subtraction", styling: styles.sectiontititle },
    { id: 3, text: "Example :", styling: [styles.text, styles.steps] },
    { id: 4, text: "10 ÷ 5", styling: [styles.text, styles.formula] },
    { id: 5, text: "Solution :", styling: [styles.text, styles.steps] },
    { id: 6, text: "Subtract the Divisor to the Divedend until Answer is 0.", styling: styles.text },
    { id: 7, text: "Step 1:", styling: [styles.text, styles.steps] },
    { id: 8, text: "10 - 5 = 5", styling: [styles.text, styles.formula] },
    { id: 9, text: "Step 2:", styling: [styles.text, styles.steps] },
    { id: 10, text: "5 - 0 = 0",styling: [styles.text, styles.formula] },
    { id: 11, text: "Count the number of the steps made until the answer is 0.", styling: styles.text },
    { id: 12, text: "Therefore,", styling: styles.text },
    { id: 12, text: "10 ÷ 5 = 2", styling: [styles.text, styles.formula] },
  ];
      ...
      {content.map((line, index) => (
        <View style={styles.container}>
          ...
          {index === 5 && (
            <Image
              contentFit="contain"
              source={require("../../../../../assets/images/catsequal.png")}
              style={[styles.image, { height: 200 }]}
            />
          )}
        </View>
