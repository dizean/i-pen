...
const WRegroup = forwardRef((props, ref) => {
  ...
  const content = [
    ...
    { id: 10, text: "8 × 8 = 64",styling: [styles.text, styles.formula] },
    ...
    { id: 27, text: "8 × 2 = 16",styling: [styles.text, styles.formula] },
    { id: 28, text: "So, let us again add this to the carry-over, that is,", styling: styles.text },
    { id: 29, text: "16 + 3 (carry-over from step 3) = 19",styling: [styles.text, styles.formula] },
    { id: 30, text: "Step 5", styling: [styles.text, styles.steps] },
    { id: 31, text: "Therefore, the product of 2468 × 8 is", styling: styles.text },
    { id: 32, text: "19744", styling: [styles.text, styles.formula] },
  ];
